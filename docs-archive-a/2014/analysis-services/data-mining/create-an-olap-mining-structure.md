...
##  <a name="requirements-for-olap-mining-structure-and-models"></a><a name="bkmk_Reqs"></a>OLAP マイニング構造およびモデルの要件  
...
##  <a name="overview-of-olap-data-mining-process"></a><a name="bkmk_Overview"></a>OLAP データマイニングプロセスの概要  
...
##  <a name="scenarios-for-use-of-data-mining-with-olap-data"></a><a name="bkmk_OLAP_Scenarios"></a>OLAP データでデータマイニングを使用するシナリオ  
...
##  <a name="slicing-a-cube-vs-filtering-models"></a><a name="bkmk_Filters"></a>キューブのスライスとモデルのフィルター処理  
...
##  <a name="using-nested-tables-in-an-olap-mining-model"></a><a name="bkmk_Nested"></a>OLAP マイニングモデルでの入れ子になったテーブルの使用  
...
##  <a name="understanding-data-mining-dimensions-and-drillthrough"></a><a name="bkmk_DMDimension"></a>データマイニングディメンションおよびドリルスルーについて  
