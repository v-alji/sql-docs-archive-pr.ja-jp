...
##  <a name="creating-data-definition-queries"></a><a name="bkmk_Create"></a>データ定義クエリの作成  
...
###  <a name="data-definition-queries-in-sql-server-data-tools"></a><a name="bkmk_ssdt"></a>SQL Server Data Tools でのデータ定義クエリ  
...
###  <a name="data-definition-queries-in-sql-server-management-studio"></a><a name="bkmk_SSMS"></a>SQL Server Management Studio でのデータ定義クエリ  
...
###  <a name="scripting-data-definition-statements"></a><a name="bkmk_Scripts"></a>データ定義ステートメントのスクリプト化  
...
##  <a name="exporting-and-importing-models"></a><a name="bkmk_Export"></a>モデルのエクスポートとインポート  
...
|[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] および [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]でのモデルの管理の詳細。|[データ マイニング オブジェクトのエクスポートおよびインポート](export-and-import-data-mining-objects.md)<br /><br /> [エクスポート &#40;DMX&#41;](/sql/dmx/export-dmx)<br /><br /> [インポート &#40;DMX&#41;](/sql/dmx/import-dmx)|  
