...
## <a name="how-the-algorithm-works"></a>アルゴリズムの動作
 ...
 ![データセットの各ケースを示す散布図](../media/clustering-plot.gif "データセットの各ケースを示す散布図")
...
## <a name="see-also"></a>参照
 [データマイニングアルゴリズム &#40;Analysis Services-データマイニング&#41;](data-mining-algorithms-analysis-services-data-mining.md) [Microsoft クラスタリングアルゴリズムテクニカルリファレンス](microsoft-clustering-algorithm-technical-reference.md)[マイニングモデルコンテンツのクラスター化モデル &#40;Analysis Services データマイニング&#41;](mining-model-content-for-clustering-models-analysis-services-data-mining.md) [クラスターモデルのクエリ例](clustering-model-query-examples.md)
