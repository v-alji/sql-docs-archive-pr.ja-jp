 ...
 **コンテンツ クエリ**  
 ...
 [DMX を使用したモデルメタデータの取得](#bkmk_Query1)  
  
 [トレーニング データの一覧を取得する](#bkmk_Query2)  
  
 [属性に関する詳細情報を検索する](#bkmk_Query3)  
  
 [システムストアドプロシージャの使用](#bkmk_Query4)  
...
###  <a name="sample-query-2-retrieving-a-summary-of-training-data"></a><a name="bkmk_Query2"></a> サンプル クエリ 2: トレーニング データの一覧を取得する  
...
###  <a name="sample-query-3-finding-more-information-about-attributes"></a><a name="bkmk_Query3"></a> サンプル クエリ 3: 属性に関する詳細情報を検索する  
...
###  <a name="sample-query-4-using-system-stored-procedures"></a><a name="bkmk_Query4"></a> サンプル クエリ 4: システム ストアド プロシージャを使用する  
...
###  <a name="sample-query-5-predicting-outcomes-using-a-singleton-query"></a><a name="bkmk_Query5"></a> サンプル クエリ 5: 単一クエリを使用して結果を予測する  
...
###  <a name="sample-query-6-getting-predictions-with-probability-and-support-values"></a><a name="bkmk_Query6"></a>サンプルクエリ 6: 確率およびサポートの値を使用して予測を取得する  
...
###  <a name="sample-query-7-predicting-associations"></a><a name="bkmk_Query7"></a>サンプルクエリ 7: アソシエーションを予測する  
...
## <a name="see-also"></a>参照  
 [Microsoft Naive Bayes アルゴリズムテクニカルリファレンス](microsoft-naive-bayes-algorithm-technical-reference.md)   
