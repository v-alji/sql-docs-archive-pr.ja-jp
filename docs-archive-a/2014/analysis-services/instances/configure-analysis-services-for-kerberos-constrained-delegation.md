...
##  <a name="allow-analysis-services-to-impersonate-a-user-identity"></a><a name="bkmk_impersonate"></a>Analysis Services がユーザー id の権限を借用することを許可する  
...
##  <a name="configure-analysis-services-for-trusted-delegation"></a><a name="bkmk_delegate"></a>信頼された委任の Analysis Services を構成する  
