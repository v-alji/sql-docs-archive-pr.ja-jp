...
|操作|[多次元モデルのアクション](actions-in-multidimensional-models.md)|  
|主要業績評価指標 (KPI)|[多次元モデルの主要業績評価指標 &#40;KPI&#41;](key-performance-indicators-kpis-in-multidimensional-models.md)|  
|計算|[多次元モデルの計算](calculations-in-multidimensional-models.md)|  
...
|[ストアドプロシージャの定義](../multidimensional-models-extending-olap-stored-procedures/defining-stored-procedures.md)|ストアド プロシージャを操作する方法について説明します。|  
