...
##  <a name="choosing-a-tool-or-approach"></a><a name="bkmk_tool"></a>ツールまたは方法の選択  
...
##  <a name="processing-objects"></a><a name="bkmk_proc"></a>オブジェクトの処理  
...
##  <a name="reprocessing-objects"></a><a name="bkmk_reproc"></a>オブジェクトの再処理  
