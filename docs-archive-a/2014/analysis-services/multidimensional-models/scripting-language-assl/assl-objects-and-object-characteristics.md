...
|*ObjectProperties*|可|要求されたオブジェクトと含まれいているマイナー オブジェクトを展開し、含まれている主要なオブジェクトは返しません。|  
|*全場合*|Ｘ|*Objectproperties*と同じですが、含まれている主要なオブジェクトの名前、ID、タイムスタンプも返されます。|  
|*ExpandFull*|可|要求されたオブジェクトと含まれているすべてのオブジェクトを再帰的に完全に展開します。|  
