...
##  <a name="view-data-refresh-history-for-an-individual-workbook"></a><a name="viewhistory"></a>個々のブックのデータ更新履歴を表示する  
...
##  <a name="view-data-refresh-history-for-all-workbooks"></a><a name="viewITOps"></a>すべてのブックのデータ更新履歴を表示する  
...
##  <a name="use-history-information"></a><a name="pageelements"></a>履歴情報の使用  
