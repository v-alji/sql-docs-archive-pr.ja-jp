...
4.  この手順を繰り返して、以下の各表に指定するように列のレポート プロパティを設定します。 他のプロパティはすべて、既定の設定のままにしておきます。  
    ...
    |月の名前|[列で並べ替え]|月|  
    |月|[非表示]|正しい|  
    |Month Calendar|[非表示]|正しい|  
    |Fiscal Quarter|[非表示]|正しい|  
    |Fiscal Year|[非表示]|正しい|  
    |Fiscal Semester|[非表示]|正しい|  
    ...
    |------------|--------------|-----------|  
    |[Product Id]|[非表示]|正しい|  
    |Product Alternate Id|[既定のラベル]|正しい|  
    |Product Subcategory Id|[非表示]|正しい|  
