...
##  <a name="exporting-knowledge-bases-to-dqsb-file"></a><a name="export"></a>ナレッジベースの dqsb ファイルへのエクスポート  
...
##  <a name="importing-knowledge-bases-from-dqsb-file"></a><a name="import"></a>Dqsb ファイルからのナレッジベースのインポート  
