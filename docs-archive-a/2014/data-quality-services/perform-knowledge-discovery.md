...
##  <a name="first-step-start-knowledge-discovery"></a><a name="FirstStep"></a>最初の手順: ナレッジ検出の開始  
...
##  <a name="discover-stage"></a><a name="Discover"></a> 検出ステージ  
...
##  <a name="manage-data-discovery-results-stage"></a><a name="Manage"></a> データの検出結果の管理ステージ  
...
4.  値の状態を変更するには、次の手順に従います。  
    ...
    2.  **選択したドメインの値をエラーとして設定**する: 値の状態を [正しい] または [無効] から [エラー] に変更するには、値を選択し、アイコンバーの下矢印または [種類] ボックスの一覧から [**選択したドメイン値をエラーとして設定**] アイコンをクリックします。 **[次に修正]** 列に修正を入力することも、空のままにしておくこともできます。  
...
##  <a name="follow-up-after-performing-knowledge-discovery"></a><a name="FollowUp"></a>補足情報: ナレッジ検出を実行した後  
