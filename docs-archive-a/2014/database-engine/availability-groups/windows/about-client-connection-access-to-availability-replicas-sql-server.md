...
-   [セカンダリロールでサポートされる接続アクセスの種類](#ConnectAccessForSecondary)  
  
-   [プライマリロールでサポートされる接続アクセスの種類](#ConnectAccessForPrimary)  
...
|1 次式|すべて (これはプライマリの既定の動作です)|読み取りのみ、読み取り/書き込み、または接続目的の指定なし|Success|  
|1 次式|読み取り/書き込み|[読み取り目的のみ]|障害|  
|1 次式|読み取り/書き込み|読み取り/書き込み、または接続目的の指定なし|Success|  
...
|Replica2|Synchronous|セカンダリ|なし|読み取り/書き込み|  
