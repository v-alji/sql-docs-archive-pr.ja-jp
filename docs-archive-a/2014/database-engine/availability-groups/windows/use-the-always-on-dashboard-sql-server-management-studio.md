...
-   **同期されていません**。 レプリカ内の 1 つ以上のデータベースが同期されておらず、可用性グループにまだ参加していません。  
  
-   **同期**中です。 レプリカ内の 1 つ以上のデータベースは同期されています。  
  
-   **同期**済み。 セカンダリ レプリカ内のすべてのデータベースは、現在のプライマリ レプリカ (ある場合) または最後のプライマリ レプリカ上の対応するプライマリ データベースと同期されています。  
