...
-   **暗号化された接続を有効にするには:**  
     ...
     [暗号化された接続を要求するようにクライアントを構成する](#ConfigureClientConnections)  
...
###  <a name="to-encrypt-a-connection-from-sql-server-management-studio"></a><a name="EncryptConnection"></a>SQL Server Management Studio からの接続を暗号化するには  
