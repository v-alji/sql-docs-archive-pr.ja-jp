...
|警告アイコン|**中断済み**|プリンシパル データベースは使用できますが、ミラー サーバーにログを送信していません。|  
|エラー アイコン|**切断**|サーバー インスタンスがパートナーに接続できません。|  
...
>  監視の更新頻度を変更することはできません。ただし、 **[データベース ミラーリングの履歴]** ダイアログ ボックスから状態テーブルを更新することは可能です。  
 ...
 タブの上にあるバナーの詳細ウィンドウには、モニターが最後に状態情報を更新した日時が [**最終更新:**] と表示されます _\<date>_ *\<time>* 。 通常、状態情報は、プリンシパル サーバー インスタンスおよびミラー サーバー インスタンスから別々の時間に取得されます。 表示されるのは、この 2 つの更新日時の古い方になります。  
