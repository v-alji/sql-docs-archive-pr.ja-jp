...
-   *パートナー間クォーラム* は、2 つのパートナーから構成されます。  
 ...
 ![クォーラム: 完全; ミラーリング監視サーバーおよびパートナー; 両方のパートナー](../media/dbm-failovautoquorum.gif "クォーラム: 完全; ミラーリング監視サーバーおよびパートナー; 両方のパートナー")  
...
### <a name="how-quorum-affects-database-availability"></a>クォーラムによるデータベースの可用性への影響  
 ...
 ![ミラーリング監視サーバーとパートナーを連携させる方法](../media/dbm-quorum-scenarios.gif "ミラーリング監視サーバーとパートナーを連携させる方法")  
