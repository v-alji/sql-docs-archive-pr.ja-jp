...
---
# <a name="running-stored-procedures-how-to-topics-odbc"></a>ストアド プロシージャを実行する方法に関するトピック (ODBC)
...
-   [ODBC&#41;&#40;リターンコードと出力パラメーターを処理する](../../relational-databases/native-client-odbc-how-to/running-stored-procedures-process-return-codes-and-output-parameters.md)  
