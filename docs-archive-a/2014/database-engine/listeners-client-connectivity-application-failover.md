...
##  <a name="availability-group-listeners"></a><a name="AGlisteners"></a>可用性グループリスナー  
...
###  <a name="availability-group-listener-configuration"></a><a name="AGlConfig"></a> 可用性グループ リスナーの構成  
...
###  <a name="selecting-an-availability-group-listener-port"></a><a name="SelectListenerPort"></a> 可用性グループ リスナー ポートの選択  
...
##  <a name="using-a-listener-to-connect-to-the-primary-replica"></a><a name="ConnectToPrimary"></a>リスナーを使用したプライマリレプリカへの接続  
...
##  <a name="using-a-listener-to-connect-to-a-read-only-secondary-replica-read-only-routing"></a><a name="ConnectToSecondary"></a> リスナーを使用した読み取り専用セカンダリ レプリカ (読み取り専用ルーティング) への接続  
...
###  <a name="to-configure-availability-replicas-for-read-only-routing"></a><a name="ConfigureARsForROR"></a> 読み取り専用ルーティングの可用性レプリカを構成するには  
...
####  <a name="related-tasks"></a><a name="RelatedTasksROR"></a> 関連タスク  
...
###  <a name="read-only-application-intent-and-read-only-routing"></a><a name="ReadOnlyAppIntent"></a>読み取り専用アプリケーションの目的および読み取り専用ルーティング  
...
####  <a name="related-tasks"></a><a name="RelatedTasksApps"></a> 関連タスク  
...
##  <a name="bypassing-availability-group-listeners"></a><a name="BypassAGl"></a>可用性グループリスナーのバイパス  
...
###  <a name="using-database-mirroring-connection-strings-with-availability-groups"></a><a name="DbmConnectionString"></a>可用性グループでのデータベースミラーリング接続文字列の使用  
...
##  <a name="behavior-of-client-connections-on-failover"></a><a name="CCBehaviorOnFailover"></a>フェールオーバー時のクライアント接続の動作  
...
##  <a name="supporting-availability-group-multi-subnet-failovers"></a><a name="SupportAgMultiSubnetFailover"></a> 可用性グループ マルチサブネット フェールオーバーのサポート  
...
##  <a name="availability-group-listeners-and-ssl-certificates"></a><a name="SSLcertificates"></a> 可用性グループ リスナーと SSL 証明書  
...
##  <a name="availability-group-listeners-and-server-principal-names-spns"></a><a name="SPNs"></a>可用性グループリスナーとサーバープリンシパル名 (Spn)  
