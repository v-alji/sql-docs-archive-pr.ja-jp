...
## <a name="ssnoversion-installation"></a>[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]スト  
...
###  <a name="upgrading-to-sscurrent"></a><a name="BKMK_Upgrading"></a>へのアップグレード[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]  
...
###  <a name="installing-sscurrent"></a><a name="BKMK_Install"></a>中[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]  
...
###  <a name="configuring-sscurrent"></a><a name="BKMK_Configure"></a>構成[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]  
...
## <a name="see-also"></a>参照  
 ...
 SQL Server[旧バージョン](backward-compatibility.md)[との互換性を維持するための製品ドキュメントを使って](../index.yml)みる  
