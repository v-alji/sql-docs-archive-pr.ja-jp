...
7.  必要に応じて、変数のプロパティを設定します。 詳細については、「 [ユーザー定義変数のプロパティを設定する](../../2014/integration-services/set-the-properties-of-a-user-defined-variable.md)によって定義された変数です。  
...
4.  削除する変数を選択し、 **[変数の削除]** をクリックします。  
     ...
     [変数] ウィンドウに変数が表示されない場合は、[**グリッドのオプション**] をクリックし、[**すべてのスコープの変数を表示**] を選択します。  
