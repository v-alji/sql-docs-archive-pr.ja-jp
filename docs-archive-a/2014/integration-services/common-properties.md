...
###  <a name="input-column-properties"></a><a name="inputcolumns"></a>入力列のプロパティ  
...
##  <a name="output-properties"></a><a name="outputs"></a>出力プロパティ  
...
###  <a name="output-column-properties"></a><a name="outputcolumns"></a>出力列のプロパティ  
