...
##  <a name="set-options-on-the-locate-packages-page"></a><a name="locate"></a>[パッケージの検索] ページのオプションの設定  
...
##  <a name="set-options-on-the-specify-project-properties-page"></a><a name="projectProperties"></a>[プロジェクトのプロパティの指定] ページのオプションの設定  
