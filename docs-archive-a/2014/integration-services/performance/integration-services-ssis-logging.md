...
### <a name="configuration-of-log-provider"></a>ログ プロバイダーの構成  
 ...
 ログ プロバイダーは、パッケージにログ記録を実装する手順の中で作成して構成します。 詳細については、「 [Integration Services Logging](integration-services-ssis-logging.md)」を参照してください。  
...
-   [[SSIS ログの構成] ダイアログボックス](../configure-ssis-logs-dialog-box.md)  
