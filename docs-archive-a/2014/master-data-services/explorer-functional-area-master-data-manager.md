...
## <a name="data-management"></a>データ管理  
 ...
 [属性の型の変更 (Excel 用 MDS アドイン)](microsoft-excel-add-in/change-the-attribute-type-mds-add-in-for-excel.md)  
 ...
 [トランザクションの注釈を設定する (マスター データ サービス)](../../2014/master-data-services/annotate-a-transaction-master-data-services.md)  
