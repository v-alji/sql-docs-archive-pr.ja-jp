...
11. [**属性**] ペインで属性をクリックし、[条件の**編集**] ペインの **[属性の選択]** ラベルにドラッグします。 この属性はルールに影響しないので、使用可能な任意の属性を選択します。  
...
## <a name="see-also"></a>参照  
 [Change Tracking グループ &#40;マスターデータサービスに属性を追加&#41;](../../2014/master-data-services/add-attributes-to-a-change-tracking-group-master-data-services.md)   
