...
## <a name="model"></a>モデル  
 ...
 [ウィザードを使用したモデルの配置パッケージの作成](../../2014/master-data-services/create-a-model-deployment-package-by-using-the-wizard.md)  
...
## <a name="business-rules"></a>ビジネス ルール  
 ...
 [ビジネス ルール条件 (マスター データ サービス)](../../2014/master-data-services/business-rule-conditions-master-data-services.md)  
