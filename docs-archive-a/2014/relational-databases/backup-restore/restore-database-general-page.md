...
> [!NOTE]  
>  を使用して復元タスクを指定する場合は [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 、[ [!INCLUDE[tsql](../../includes/tsql-md.md)] **スクリプト**] をクリックしてスクリプトの保存先を選択することにより、対応する[restore](/sql/t-sql/statements/restore-statements-transact-sql)スクリプトを生成できます。  
