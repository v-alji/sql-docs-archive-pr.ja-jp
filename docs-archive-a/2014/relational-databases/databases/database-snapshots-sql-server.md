...
###  <a name="limitations-on-the-source-database"></a><a name="LimitsOnSourceDb"></a> ソース データベースへの制限  
...
###  <a name="limitations-on-database-snapshots"></a><a name="LimitsOnDbSS"></a> データベース スナップショットへの制限  
...
###  <a name="database-snapshots-with-offline-filegroups"></a><a name="OfflineFGs"></a> オフライン ファイル グループを含むデータベース スナップショット  
