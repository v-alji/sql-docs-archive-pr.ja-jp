...
##  <a name="before-you-begin"></a><a name="before_you_begin"></a> はじめに  
...
###  <a name="considerations-for-deploying-a-filestream-enabled-database-to-an-azure-vm"></a><a name="filestream"></a> FILESTREAM が有効なデータベースの Azure 仮想マシンへの配置に関する注意点  
...
###  <a name="considerations-for-geographic-distribution-of-assets"></a><a name="geography"></a>資産の地理的分散に関する考慮事項  
...
###  <a name="wizard-configuration-settings"></a><a name="configuration_settings"></a>ウィザードの構成設定  
...
##  <a name="using-the-deploy-database-to-azure-vm-wizard"></a><a name="launch_wizard"></a>Azure 仮想マシンへのデータベースの配置ウィザードの使用  
...
## <a name="see-also"></a>参照  
 [SQL Server のクラウドアダプター](../../database-engine/cloud-adapter-for-sql-server.md)   
 [データベースライフサイクル管理](../database-lifecycle-management.md)   
 [データ層アプリケーションのエクスポート](../data-tier-applications/export-a-data-tier-application.md)   
 [BACPAC ファイルをインポートして新しいユーザーデータベースを作成する](../data-tier-applications/import-a-bacpac-file-to-create-a-new-user-database.md)   
 [Azure SQL Database のバックアップと復元](https://msdn.microsoft.com/library/azure/jj650016.aspx)   
 [Azure Virtual Machines での SQL Server デプロイ](https://msdn.microsoft.com/library/dn133141.aspx)   
 [Azure の仮想マシンに SQL Server を移行するための準備](https://msdn.microsoft.com/library/dn133142.aspx)  
