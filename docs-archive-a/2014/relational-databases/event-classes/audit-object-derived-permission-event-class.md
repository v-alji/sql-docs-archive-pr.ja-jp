...
# <a name="audit-object-derived-permission-event-class"></a>Audit Object Derived Permission イベント クラス
 ...
 このイベント クラスは、今後のバージョンの [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]で廃止される可能性があります。 代わりに、 **Audit Schema Object Management** イベント クラスを使用することをお勧めします。  
...
|**DBUserName**|**nvarchar**|データベースに格納されている実行者のユーザー名。|40|はい|  
|**EventClass**|**int**|イベントの種類 = 118。|27|いいえ|  
|**EventSequence**|**int**|要求内の特定のイベントのシーケンス。|51|いいえ|  
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 作成<br /><br /> 2 = 変更<br /><br /> 3 = 削除<br /><br /> 4 = ダンプ<br /><br /> 11 = 読み込み|21|はい|  
...
|**ObjectName**|**nvarchar**|作成、変更、または削除されるオブジェクトの名前。|34|はい|  
...
|**OwnerName**|**nvarchar**|作成、変更、または削除されるオブジェクトの所有者のデータベース ユーザー名。|37|はい|  
