...
## <a name="audit-server-principal-impersonation-event-class-data-columns"></a>Audit Server Principal Impersonation イベント クラスのデータ列  
...
|**Success**|**int**|1 = 成功。 0 = 失敗。 たとえば、値が 1 の場合は権限チェックの成功を表し、値が 0 の場合は失敗を表します。|23|はい|  
