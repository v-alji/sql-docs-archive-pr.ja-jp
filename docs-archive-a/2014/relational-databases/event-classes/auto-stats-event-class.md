...
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1: 統計が同期的に作成または更新されます。**TextData**列は、どの統計が作成または更新されたかを示します。<br /><br /> 2: 統計の非同期更新。ジョブがキューに登録されました。<br /><br /> 3: 統計の非同期更新。ジョブが開始しました。<br /><br /> 4: 統計の非同期更新。ジョブが完了しました。|21|はい|  
...
|**Success**|**int**|0 = エラー。<br /><br /> 1 = 成功。<br /><br /> 2 = サーバーの絞込みによりスキップ (MSDE)。|23|はい|  
