...
## <a name="bitmap-warning-event-class-data-columns"></a>Bitmap Warning イベント クラスのデータ列  
...
|**LoginName**|`nvarchar`|ユーザーのログイン名 ( [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] セキュリティログインまたは*DOMAIN\username*という形式の Windows ログイン資格情報)。|11|はい|  
