...
## <a name="package-contents"></a>パッケージの内容  
 ...
 ![モジュール、パッケージ、およびオブジェクトの関係](../../database-engine/media/xepackagesobjects.gif "モジュール、パッケージ、およびオブジェクトの関係")  
...
|運用時|運用イベントは、問題や事象の分析および診断のために使用されます。 これらは、問題や現象に基づいてツールやタスクをトリガーするために使用できます。 たとえば、プリンターがシステムに追加されたり、システムから削除された場合に発生するイベントなどがあります。|  
...
## <a name="see-also"></a>参照  
 [拡張イベントセッションの SQL Server](sql-server-extended-events-sessions.md)   
 [拡張イベントエンジンの SQL Server](sql-server-extended-events-engine.md)   
