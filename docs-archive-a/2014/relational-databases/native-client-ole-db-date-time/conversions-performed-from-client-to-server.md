...
## <a name="conversions"></a>変換  
 ...
 ICommandWithParameters:: SetParameterInfo が呼び出されなかった場合、DBTYPE_DBTIMESTAMP バインドはとして変換され `datetime2` ます。  
...
|14|より前 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] のの変換セマンティクス `smalldatetime` は維持されます。 秒は 0 に設定されます。|  
|15|より前 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] のの変換セマンティクス `datetime` は維持されます。 秒は、1/300 秒単位に丸められます。|  
