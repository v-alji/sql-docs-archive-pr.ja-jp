...
ms.locfileid: "87643805"
---
# <a name="retrieving-error-information"></a><span data-ttu-id="0c0cf-102">エラー情報の取得</span><span class="sxs-lookup"><span data-stu-id="0c0cf-102">Retrieving Error Information</span></span>
  <span data-ttu-id="0c0cf-103">この例では、Native Client OLE DB プロバイダーによって公開されるさまざまなエラーインターフェイスから情報を取得し [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ます。</span><span class="sxs-lookup"><span data-stu-id="0c0cf-103">This example obtains information from the various error interfaces exposed by the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB provider.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="0c0cf-104">参照</span><span class="sxs-lookup"><span data-stu-id="0c0cf-104">See Also</span></span>  
 [<span data-ttu-id="0c0cf-105">エラー</span><span class="sxs-lookup"><span data-stu-id="0c0cf-105">Errors</span></span>](errors.md)  
