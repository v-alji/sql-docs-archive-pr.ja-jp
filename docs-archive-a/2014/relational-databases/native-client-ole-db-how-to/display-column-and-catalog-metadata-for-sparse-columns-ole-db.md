...
ms.locfileid: "87718122"
---
# <a name="display-column-and-catalog-metadata-for-sparse-columns-ole-db"></a><span data-ttu-id="11b0d-102">スパース列に対する列およびカタログ メタデータの表示 (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="11b0d-102">Display Column and Catalog Metadata for Sparse Columns (OLE DB)</span></span>
  <span data-ttu-id="11b0d-103">このサンプルでは、スパース列、非スパース列、columnset 列の 3 つの列を持ったテーブルを作成します。</span><span class="sxs-lookup"><span data-stu-id="11b0d-103">This sample creates a table with three columns: a sparse column, a column that is not a sparse column, and a columnset column.</span></span> <span data-ttu-id="11b0d-104">その後、非スパース列および columnset 列に対する列およびカタログ メタデータを示す OLE DB フラグを表示します。</span><span class="sxs-lookup"><span data-stu-id="11b0d-104">The sample then displays OLE DB flags showing the column and catalog metadata for the non-sparse column and the columnset column.</span></span>  
  
 <span data-ttu-id="11b0d-105">このサンプルは、[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 以降で動作します。</span><span class="sxs-lookup"><span data-stu-id="11b0d-105">This sample works with [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] or later.</span></span> <span data-ttu-id="11b0d-106">スパース列の詳細については、「 [SQL Server Native Client でのスパース列のサポート](../native-client/features/sparse-columns-support-in-sql-server-native-client.md)」を参照してください。</span><span class="sxs-lookup"><span data-stu-id="11b0d-106">For more information about sparse columns, see [Sparse Columns Support in SQL Server Native Client](../native-client/features/sparse-columns-support-in-sql-server-native-client.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="11b0d-107">例</span><span class="sxs-lookup"><span data-stu-id="11b0d-107">Example</span></span>  
 <span data-ttu-id="11b0d-108">INCLUDE 環境変数に、sqlncli を含むディレクトリが含まれていることを確認します。</span><span class="sxs-lookup"><span data-stu-id="11b0d-108">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
