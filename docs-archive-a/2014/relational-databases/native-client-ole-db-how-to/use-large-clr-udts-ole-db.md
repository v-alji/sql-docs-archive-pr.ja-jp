...
ms.locfileid: "87713118"
---
# <a name="use-large-clr-udts-ole-db"></a><span data-ttu-id="6a86c-102">大きな CLR UDT の使用 (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="6a86c-102">Use Large CLR UDTs (OLE DB)</span></span>
  <span data-ttu-id="6a86c-103">このサンプルでは、大きなユーザー定義型を持つ行を結果セットからフェッチする方法を示します。</span><span class="sxs-lookup"><span data-stu-id="6a86c-103">This sample shows how to fetch rows with large user-defined types from a result set.</span></span> <span data-ttu-id="6a86c-104">詳細については、「[大きな CLR ユーザー定義型 &#40;OLE DB&#41;](../native-client/ole-db/large-clr-user-defined-types-ole-db.md)」を参照してください。</span><span class="sxs-lookup"><span data-stu-id="6a86c-104">For more information, see [Large CLR User-Defined Types &#40;OLE DB&#41;](../native-client/ole-db/large-clr-user-defined-types-ole-db.md).</span></span> <span data-ttu-id="6a86c-105">このサンプルは、[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 以降で動作します。</span><span class="sxs-lookup"><span data-stu-id="6a86c-105">This sample works with [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] or later.</span></span>  
  
## <a name="example"></a><span data-ttu-id="6a86c-106">例</span><span class="sxs-lookup"><span data-stu-id="6a86c-106">Example</span></span>  
 <span data-ttu-id="6a86c-107">このサンプルには 2 つのプロジェクトが含まれています。</span><span class="sxs-lookup"><span data-stu-id="6a86c-107">This sample contains two projects.</span></span> <span data-ttu-id="6a86c-108">1 つは、C# ソース コードからアセンブリ (DLL) を作成するプロジェクトです。</span><span class="sxs-lookup"><span data-stu-id="6a86c-108">One project creates an assembly (DLL) from C# source code.</span></span> <span data-ttu-id="6a86c-109">このアセンブリには、CLR 型が格納されます。</span><span class="sxs-lookup"><span data-stu-id="6a86c-109">This assembly contains the CLR type.</span></span> <span data-ttu-id="6a86c-110">テーブルがデータベースに追加されます。</span><span class="sxs-lookup"><span data-stu-id="6a86c-110">A table will be added to the database.</span></span> <span data-ttu-id="6a86c-111">テーブルの列の型はアセンブリで定義されます。このサンプルでは、既定で master データベースを使用します。</span><span class="sxs-lookup"><span data-stu-id="6a86c-111">A column in the table will be of a type defined in the assembly, By default, this sample will use the master database.</span></span> <span data-ttu-id="6a86c-112">もう 1 つのプロジェクトは、テーブルからデータを読み取るネイティブの C++ アプリケーションです。</span><span class="sxs-lookup"><span data-stu-id="6a86c-112">The second project is a native C application that reads data from the table.</span></span>  
  
 <span data-ttu-id="6a86c-113">1 つ目の (C#) コード リストを DLL にコンパイルします。</span><span class="sxs-lookup"><span data-stu-id="6a86c-113">Compile the first (C#) code listing to a DLL.</span></span>  <span data-ttu-id="6a86c-114">次に、この DLL を C ドライブのルート ディレクトリにコピーします。</span><span class="sxs-lookup"><span data-stu-id="6a86c-114">Then, copy the DLL to the root directory of the C drive.</span></span>  
  
 <span data-ttu-id="6a86c-115">2 つ目の ( [!INCLUDE[tsql](../../includes/tsql-md.md)]) コード リストを実行して、アセンブリを master データベースに追加します。</span><span class="sxs-lookup"><span data-stu-id="6a86c-115">Execute the second ([!INCLUDE[tsql](../../includes/tsql-md.md)]) code listing to add the assembly to the master database.</span></span>  
  
 <span data-ttu-id="6a86c-116">ole32.lib と oleaut32.lib を使用して 3 つ目の (C++) コード リストをコンパイルし、実行します。</span><span class="sxs-lookup"><span data-stu-id="6a86c-116">Compile with ole32.lib oleaut32.lib and execute the third (C++) code listing.</span></span> <span data-ttu-id="6a86c-117">このアプリケーションは、コンピューターの既定の [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] インスタンスに接続します。</span><span class="sxs-lookup"><span data-stu-id="6a86c-117">This application connects to your computer's default [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="6a86c-118">一部の Windows オペレーティング システムでは、(localhost) または (local) を実際の [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] インスタンスの名前に変更する必要があります。</span><span class="sxs-lookup"><span data-stu-id="6a86c-118">On some Windows operating systems, you will need to change (localhost) or (local) to the name of your [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="6a86c-119">名前付きインスタンスに接続するには、接続文字列を L"(local)" から L"(local)\\\name" に変更します。ここで、name は名前付きインスタンスです。</span><span class="sxs-lookup"><span data-stu-id="6a86c-119">To connect to a named instance, change the connection string from L"(local)" to L"(local)\\\name" , where name is the named instance.</span></span> <span data-ttu-id="6a86c-120">[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express は、既定で名前付きインスタンスとしてインストールされます。</span><span class="sxs-lookup"><span data-stu-id="6a86c-120">By default, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express installs to a named instance.</span></span> <span data-ttu-id="6a86c-121">INCLUDE 環境変数に、sqlncli を含むディレクトリが含まれていることを確認します。</span><span class="sxs-lookup"><span data-stu-id="6a86c-121">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="6a86c-122">4 つ目の ( [!INCLUDE[tsql](../../includes/tsql-md.md)]) コード リストを実行して、アセンブリを master データベースから削除します。</span><span class="sxs-lookup"><span data-stu-id="6a86c-122">Execute the fourth ([!INCLUDE[tsql](../../includes/tsql-md.md)]) code listing to delete the assembly to the master database.</span></span>  
