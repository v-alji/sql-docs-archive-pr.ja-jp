...
##  <a name="how-transactional-replication-works"></a><a name="HowWorks"></a> トランザクション レプリケーションの動作方法
...
##  <a name="initial-dataset"></a><a name="Dataset"></a> 初期データセット
...
##  <a name="modifying-data-and-the-log-reader-agent"></a><a name="LogReaderAgent"></a> データの変更およびログ リーダー エージェント
...
##  <a name="distribution-agent"></a><a name="DistributionAgent"></a> ディストリビューション エージェント
