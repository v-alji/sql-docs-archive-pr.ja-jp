 ...
 **[大文字と小文字を区別する]**  
 このチェック ボックスをオンにすると、検索結果ウィンドウには、 **[検索する文字列]** で指定した文字列に大文字と小文字の違いを含めて完全に一致するインスタンスのみが検索結果ウィンドウに表示されます。 たとえば、[**大文字と小文字を区別**する] チェックボックスをオンにした状態で**myobject**を検索すると、"myobject" や "myobject" ではなく "myobject" が返されます。  
