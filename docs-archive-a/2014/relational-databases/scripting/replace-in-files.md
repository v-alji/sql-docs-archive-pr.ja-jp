 ...
 **[検索対象]** ドロップダウン リストから選択したオプションで、 **[フォルダーを指定して置換]** の検索を現在アクティブなファイル内でだけ実行するか、特定のフォルダー内のすべてのファイルに対して実行するかが決まります。 一覧から検索範囲を選択するか、フォルダーパスを入力するか、[**参照**] ボタンをクリックして [**カスタムディレクトリセット**] ダイアログボックスを表示し、検索するフォルダーのセットを選択します。  
