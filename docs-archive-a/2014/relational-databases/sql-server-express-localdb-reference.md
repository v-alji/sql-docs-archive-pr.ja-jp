...
ms.locfileid: "87642014"
---
# <a name="sql-server-express-localdb-reference"></a><span data-ttu-id="69036-102">SQL Server Express LocalDB リファレンス</span><span class="sxs-lookup"><span data-stu-id="69036-102">SQL Server Express LocalDB Reference</span></span>
  <span data-ttu-id="69036-103">ここでは、SQL Server Express LocalDB について説明します。</span><span class="sxs-lookup"><span data-stu-id="69036-103">This section contains information about the SQL Server Express LocalDB:</span></span>  
  
-   [<span data-ttu-id="69036-104">SQL Server Express LocalDB のエラー メッセージ リファレンス</span><span class="sxs-lookup"><span data-stu-id="69036-104">SQL Server Express LocalDB Error Message Reference</span></span>](express-localdb-error-messages/sql-server-express-localdb-reference-error-messages.md)  
  
-   [<span data-ttu-id="69036-105">SQL Server Express LocalDB のインスタンス API リファレンス</span><span class="sxs-lookup"><span data-stu-id="69036-105">SQL Server Express LocalDB Instance API Reference</span></span>](express-localdb-instance-apis/sql-server-express-localdb-reference-instance-apis.md)  
  
## <a name="code-sample"></a><span data-ttu-id="69036-106">コード サンプル</span><span class="sxs-lookup"><span data-stu-id="69036-106">Code Sample</span></span>  
 <span data-ttu-id="69036-107">次のサンプルは、LocalDB API の使い方を示しています。</span><span class="sxs-lookup"><span data-stu-id="69036-107">The following sample demonstrates the LocalDB API.</span></span>  <span data-ttu-id="69036-108">このサンプルを実行する前に、LocalDB がコンピューターにインストールされていることを確認してください。</span><span class="sxs-lookup"><span data-stu-id="69036-108">Make sure that LocalDB is installed on the computer before running this sample.</span></span>  <span data-ttu-id="69036-109">LocalDB は、[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express のセットアップからインストールできます。</span><span class="sxs-lookup"><span data-stu-id="69036-109">You can install LocalDB from setup in the [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span></span>  
