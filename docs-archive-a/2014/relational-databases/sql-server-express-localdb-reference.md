...
-   [SQL Server Express LocalDB のエラー メッセージ リファレンス](express-localdb-error-messages/sql-server-express-localdb-reference-error-messages.md)  
...
## <a name="code-sample"></a>コード サンプル  
 次のサンプルは、LocalDB API の使い方を示しています。  このサンプルを実行する前に、LocalDB がコンピューターにインストールされていることを確認してください。  LocalDB は、[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express のセットアップからインストールできます。  
