...
-   クライアント側の書式設定  
 ...
 ここでは、のデータベースに対して実行されるクエリによって生成される行セットから、クライアント側またはサーバー側で XML ドキュメントを書式設定する方法について説明 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] します。  
