...
## <a name="see-also"></a>参照  
 [WMI Provider for Configuration Management について](understanding-the-wmi-provider-for-configuration-management.md)   
