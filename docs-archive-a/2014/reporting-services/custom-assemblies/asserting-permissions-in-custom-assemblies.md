...
1.  セキュリティで保護された呼び出しを行うために、コードに必要な正しい権限を識別します。 このメソッドがライブラリの一部である場合は [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 、この情報をメソッドドキュメントに含める必要があります。  
