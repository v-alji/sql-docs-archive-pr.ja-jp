...
### <a name="customize-an-embedded-report-viewer-in-a-web-page"></a>Web ページ上の埋め込みレポート ビューアーのカスタマイズ  
 ...
 レポートビューアー Web パーツを Web ページに埋め込む場合は、[**レポート URL** ] プロパティを特定のレポートに設定する必要があります。 この操作を行わないと、レポートへのリンクを求めるメッセージがレポート ビューアーに表示されます。 このメッセージのカスタマイズや削除はできません。  
...
|[ATOM フィードのボタンを表示する]|ツール バーの ATOM フィードのボタンの表示と非表示を切り替えます。<br /><br /> ![htmlviewer_datafeed](media/htmlviewer-datafeed.gif "htmlviewer_datafeed")|  
|[ツール バーの位置]|レポート ビューアー内のツール バーの位置を決定します。 有効な値として、`Top` および `Bottom` があります。|  
