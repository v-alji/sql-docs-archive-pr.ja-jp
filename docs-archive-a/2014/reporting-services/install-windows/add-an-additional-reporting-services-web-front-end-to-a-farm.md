...
## <a name="see-also"></a>参照
 [ファームに Web サーバーまたはアプリケーションサーバーを追加する (Sharepoint server 2010) サービスを](https://technet.microsoft.com/library/bb218968.aspx?missingurl=%2fen-us%2flibrary%2fe1aeaddf-6ee4-43a9-82b7-db20b68c71db\(Office.14\))[構成する (sharepoint server 2010)](https://technet.microsoft.com/library/ee794878.aspx)
