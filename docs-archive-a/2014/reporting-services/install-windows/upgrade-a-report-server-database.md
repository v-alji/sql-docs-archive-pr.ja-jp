 ...
 **ネイティブモード:**[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]ネイティブモードでは、レポートサーバーデータベースは、実際には "ReportServer と ReportServerTempDB" という既定の名前を持つ2つのデータベースで構成されています。  
  
 **SharePoint モード:**[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint モードでは、実際には、レポートサーバーデータベースは、サービスアプリケーションの各インスタンスに対して作成されるデータベースのコレクションです [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 。  
