...
##  <a name="saving-report-definitions"></a><a name="SavingReportDefinitions"></a>レポート定義の保存  
...
##  <a name="exporting-and-saving-reports"></a><a name="ExportingAndSavingReports"></a> レポートのエクスポートと保存  
...
##  <a name="using-file-share-delivery"></a><a name="UsingFileShareDelivery"></a> ファイル共有配信の使用  
...
##  <a name="using-report-history"></a><a name="UsingReportHistory"></a> レポート履歴の使用  
