...
## <a name="see-also"></a>参照  
 [レポートまたはモデルの共有データソースへのバインド &#40;SSRS&#41;](bind-a-report-or-model-to-a-shared-data-source-ssrs.md)   
 [共有データソース &#40;レポートマネージャーの作成、削除、または変更&#41;](../create-delete-or-modify-a-shared-data-source-report-manager.md)   
 [Reporting Services データソースへの資格情報の格納](store-credentials-in-a-reporting-services-data-source.md)   
