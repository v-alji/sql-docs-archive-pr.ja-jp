...
2.  プロパティペインで、プロパティフィールドにメッセージとして表示するテキストを入力し `NoRowsMessage` ます。  
...
2.  プロパティペインで、のノードを展開し `NoDataMessage` ます。  
  
3.  [**キャプション**] に、プロパティフィールドにメッセージとして表示するテキストを入力し `NoDataMessage` ます。  
