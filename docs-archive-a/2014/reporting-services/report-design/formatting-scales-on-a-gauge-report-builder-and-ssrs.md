...
# <a name="formatting-scales-on-a-gauge-report-builder-and-ssrs"></a>ゲージのスケールの書式設定 (レポート ビルダーおよび SSRS)
 ...
 ![ゲージ スケールの要素の概要](../media/scaleoverviewdiagram.gif "ゲージ スケールの要素の概要")
...
## <a name="see-also"></a>参照
 [ゲージの範囲の書式設定 &#40;レポートビルダーと ssrs&#41;](formatting-ranges-on-a-gauge-report-builder-and-ssrs.md) [ゲージ上のポインターの書式設定 &#40;レポートビルダー](formatting-pointers-on-a-gauge-report-builder-and-ssrs.md)および ssrs&#41;[日付または通貨として軸ラベル](format-axis-labels-as-dates-or-currencies-report-builder-and-ssrs.md)を書式設定 &#40;レポートビルダーと ssrs&#41;[グラフの軸ラベル](formatting-axis-labels-on-a-chart-report-builder-and-ssrs.md)を書式設定する &#40;レポートビルダーと ssrs&#41;ゲージ &#40;レポートビルダーと[ssrs&#41;](gauges-report-builder-and-ssrs.md)
