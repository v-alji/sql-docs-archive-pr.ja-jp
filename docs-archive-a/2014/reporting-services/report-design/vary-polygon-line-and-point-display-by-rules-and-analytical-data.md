...
##  <a name="understanding-rules"></a><a name="Rules"></a> ルールについて  
...
##  <a name="understanding-color-rules"></a><a name="Color"></a> 色ルールについて  
...
##  <a name="understanding-line-width-rules"></a><a name="Width"></a> 線幅ルールについて  
...
##  <a name="understanding-marker-size-rules"></a><a name="Size"></a> マーカーのサイズ ルールについて  
...
##  <a name="understanding-marker-type-rules"></a><a name="Marker"></a> マーカーの種類ルールについて  
...
##  <a name="understanding-distribution-options"></a><a name="Distribution"></a> 分布オプションについて  
...
##  <a name="understanding-legends-and-legend-items"></a><a name="Legends"></a> 凡例および凡例項目について  
