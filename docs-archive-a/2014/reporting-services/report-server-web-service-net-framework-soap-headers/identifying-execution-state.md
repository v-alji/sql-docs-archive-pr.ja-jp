...
# <a name="identifying-execution-state"></a>実行状態の識別
 ...
 ![レポートの処理および表示 パス](../../../2014/reporting-services/media/rs-render-process-diagram.gif "レポートの処理および表示パス")
...
## <a name="see-also"></a>参照
 <xref:ReportExecution2005.ReportExecutionService.Render%2A>[REPORTING SERVICES SOAP ヘッダーを使用し](../report-server-web-service-net-framework-soap-headers/using-reporting-services-soap-headers.md)た[SSRS&#41;&#40;テクニカルリファレンス](../../../2014/reporting-services/technical-reference-ssrs.md)
