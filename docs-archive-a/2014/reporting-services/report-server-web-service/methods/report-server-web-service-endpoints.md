...
|プロキシ エンドポイント|説明|  
|--------------------|-----------------|  
|<xref:ReportService2006>|SharePoint 統合モード用に構成されたレポート サーバーを管理するための API を提供します。 **注:** このエンドポイントは、では非推奨とされ [!INCLUDE[ssKilimanjaro](../../../includes/sskilimanjaro-md.md)] ます。|  
