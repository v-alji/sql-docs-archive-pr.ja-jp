...
|トピック|説明|  
|-----------|-----------------|  
|[レポート サーバー Web サービスのエンドポイント](report-server-web-service-endpoints.md)|レポート サーバー Web サービスの管理用エンドポイントと実行用エンドポイントについて説明します。|  
...
|[承認方法](authorization-methods.md)|タスク、ロール、およびポリシーの管理に使用できるメソッドについて説明します。|  
