...
# <a name="creating-the-web-service-proxy"></a>Web サービス プロキシの作成
 ...
 を使用して開発プロジェクトにプロキシクラスを追加するには、の WSDL ツールを使用する方法 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] と、で Web 参照を追加する [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] 方法の2つがあります。 ここでは、これらの方法について詳しく説明します。  
