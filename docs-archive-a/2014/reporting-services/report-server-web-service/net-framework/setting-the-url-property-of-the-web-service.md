...
# <a name="setting-the-url-property-of-the-web-service"></a>Web サービスの Url プロパティの設定
  アプリケーションでいつでも [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] 、アプリケーションの現在の送信先であるレポートサーバー Web サービスのベース URL を変更できます。 そのためには、サービス オブジェクトの **Url** プロパティを設定します。 次に例を示します。  
