...
##  <a name="report-server-items"></a><a name="bkmk_ReportServerItems"></a>レポートサーバーアイテム
...
##  <a name="my-reports"></a><a name="bkmk_MyReports"></a>個人用レポート
...
|@ (アット マーク)|[at]|*ユーザー名* @hotmail.com*username*[at] hotmail .com になります。|
|& (アンパサンド)|[amp]|*ユーザー名* @*会社* &*company.com*は、 *username*[at]*company*[amp]*company.com*になります。|
|$ (ドル記号)|[dollar]|*ユーザー*  $*名前*は*User*[] [ドル]*名*になります|
...
## <a name="see-also"></a>参照
 [Reporting Services ツール](../tools/reporting-services-tools.md)[のロールと権限 &#40;Reporting Services&#41;](../security/roles-and-permissions-reporting-services.md) [Reporting Services レポート &#40;SSRS&#41;](../reports/reporting-services-reports-ssrs.md)
