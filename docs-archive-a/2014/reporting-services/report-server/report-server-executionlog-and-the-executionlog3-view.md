...
|ItemAction|指定できる値<br /><br /> **レンダリング**<br /><br /> **Sort**<br /><br /> **BookMarkNavigation**<br /><br /> **DocumentNavigation**<br /><br /> **GetDocumentMap**<br /><br /> **Findstring**<br /><br /> **おい**<br /><br /> **RenderEdit**|  
...
-   **Externalimages**値はミリ秒にあります。 このデータはパフォーマンスに関する問題の診断に使用できます。 外部 Web サーバーからイメージを取得するのに時間がかかり、レポートの実行全体が遅くなる場合があります。 で追加されました [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 。  
...
-   **Connections**: 複数の平準化構造。 で追加されました [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 。  
