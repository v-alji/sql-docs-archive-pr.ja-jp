...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] のモジュール式アーキテクチャは、拡張性を考慮して設計されています。 マネージド コード API を使用して、[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] の多くのコンポーネントで使用される拡張機能を容易に開発、インストール、および管理できます。 を使用してアセンブリを作成 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] し、 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 進化するビジネスニーズに合わせて、新しいレンダリング、セキュリティ、配信、およびデータ処理機能を追加することができます。  
