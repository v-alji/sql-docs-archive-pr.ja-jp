...
##  <a name="feature-summary"></a><a name="bkmk_featuresum"></a>機能の概要
...
##  <a name="connected-mode-and-local-mode"></a><a name="bkmk_connectedandlocal"></a>接続モードとローカルモード
...
##  <a name="unsupported-sharepoint-features"></a><a name="bkmk_unsupportedsharepoint"></a>サポートされていない SharePoint 機能
...
##  <a name="supported-combinations-of-the-sharepoint-add-in-and-report-server"></a><a name="bkmk_supportedcombinations"></a>SharePoint アドインとレポートサーバーのサポートされる組み合わせ
...
##  <a name="components-that-provide-integration"></a><a name="bkmk_components"></a>統合を提供するコンポーネント

 サーバーを単一の配置にまとめるには、のインストールと [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] SharePoint 製品のインスタンスを統合します。  
...
##  <a name="language-considerations"></a><a name="bkmk_language"></a>言語に関する考慮事項
