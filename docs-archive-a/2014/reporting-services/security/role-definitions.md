...
## <a name="creating-a-role-definition"></a>ロールの定義の作成  
 ...
 ロールの定義を作成するには、を使用し [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] ます。 詳細については、「 [ロールを作成、削除、または変更する &#40;Management Studio&#41;](role-definitions-create-delete-or-modify.md)」を参照してください。  
