 ...
 **Type**  
 使用しているデータソースの種類を選択します (たとえば、データベースを使用している場合は、を [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 選択し [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] ます)。  
