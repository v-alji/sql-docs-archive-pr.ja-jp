...
-   [共有スケジュールの作成および管理 (SharePoint モード)](#bkmk_sharepoint)  
  
-   [共有スケジュールの作成および管理 (ネイティブ モード)](#bkmk_native)  
  
##  <a name="overview-of-managing-shared-schedules"></a><a name="bkmk_overview"></a>共有スケジュールの管理の概要  
...
##  <a name="create-and-manage-shared-schedules-native-mode"></a><a name="bkmk_native"></a>共有スケジュールの作成と管理 (ネイティブモード)  
...
## <a name="see-also"></a>参照  
 ...
 [レポート &#40;レポートマネージャー&#41;にキャッシュする](../report-server/cache-a-report-report-manager.md)   
