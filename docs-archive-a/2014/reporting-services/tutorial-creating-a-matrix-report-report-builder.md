...
# <a name="tutorial-creating-a-matrix-report-report-builder"></a>チュートリアル: マトリックス レポートの作成 (レポート ビルダー)
 ...
 このチュートリアルで作成するレポートの拡張バージョンは、サンプルレポートビルダーレポートとして入手でき [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] ます。 このサンプルレポートおよびその他のレポートをダウンロードする方法の詳細については、「[レポートビルダーサンプルレポート](https://go.microsoft.com/fwlink/?LinkId=184851)」を参照してください。  
...
4.  CanGrow プロパティがに設定されていることを確認し `True` ます。  
