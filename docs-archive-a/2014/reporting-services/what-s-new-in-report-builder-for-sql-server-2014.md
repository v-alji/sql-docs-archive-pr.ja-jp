...
# <a name="what39s-new-in-report-builder-for-sql-server-2014"></a>SQL Server 2014 のレポートビルダーの新&#39;
 ...
 このリリースの他の製品およびテクノロジの機能の詳細について [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] は、「 [SQL Server 2014 の新](../sql-server/what-s-new-in-sql-server-2016.md)機能」を参照してください。  
