...
2.  [エラーの特定](failover-policy-for-failover-cluster-instances.md#determine)  
...
####  <a name="determining-failures"></a><a name="determine"></a> エラーの特定  
 ...
 「[sp_server_diagnostics &#40;Transact-SQL&#41;](/sql/relational-databases/system-stored-procedures/sp-server-diagnostics-transact-sql)」を確認してください。このシステム ストアド プロシージャは、エラー条件レベルで重要な役割を果たします。  
