...
##  <a name="general-sharepoint-2010-requirements"></a><a name="bkmk_generalsharepoint"></a>SharePoint 2010 の一般的な要件
...
##  <a name="sharepoint-editions-and-bi-feature-support"></a><a name="bkmk_vers"></a>SharePoint のエディションと BI 機能のサポート
...
###  <a name="sharepoint-2010-products-preparation-tool"></a><a name="bkmk_prereq"></a>SharePoint 2010 製品準備ツール
...
###  <a name="requirements-and-suggestions-for-running-the-sharepoint-installation"></a><a name="bkmk_install"></a>SharePoint インストールを実行するための要件と推奨事項
...
## <a name="see-also"></a>参照
 [Sharepoint server 2010 のインストールと配置](https://technet.microsoft.com/sharepoint/ee518643.aspx) [3 層ファーム用の複数サーバー (sharepoint server 2010)](https://go.microsoft.com/fwlink/?linkID=219834)
