...
##  <a name="step-2-configure-the-server"></a><a name="bkmk_config"></a>手順 2: サーバーを構成する
...
##  <a name="step-4-verify-the-installation"></a><a name="bkmk_verify"></a>手順 4: インストールを確認する
...
## <a name="see-also"></a>参照
 [PowerPivot for SharePoint 2010 インストール](../../../2014/sql-server/install/powerpivot-for-sharepoint-2010-installation.md)[配置チェックリスト: Reporting Services、Power View、および PowerPivot for SharePoint の](deployment-checklist-reporting-services-power-view-power-pivot-for-sharepoint.md)[配置チェックリスト: SharePoint 2010 ファームへの PowerPivot サーバーの追加によるスケールアウト](../../../2014/sql-server/install/deployment-checklist-scale-out-adding-powerpivot-servers-sharepoint-2010-farm.md)[の展開チェックリスト: PowerPivot for SharePoint 2010 のマルチサーバーインストール](../../../2014/sql-server/install/deployment-checklist-multiserver-installation-powerpivot-sharepoint-2010.md)
