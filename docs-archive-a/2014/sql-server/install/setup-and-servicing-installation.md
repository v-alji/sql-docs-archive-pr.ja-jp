...
-   [SQL Server 2014 セットアップのユーザー インターフェイス](../../../2014/sql-server/install/sql-server-2014-setup-user-interface.md)  
  
-   [SQL Server サービスのインストール](../../../2014/sql-server/install/sql-server-servicing-installation.md)  
