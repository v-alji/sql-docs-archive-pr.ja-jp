---
title: アップグレードアドバイザーの操作方法に関するトピック |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [アップグレード アドバイザーを起動する方法](../../../2014/sql-server/install/how-to-launch-upgrade-advisor.md)  
  
 [アップグレード アドバイザー分析ウィザードを実行する方法](../../../2014/sql-server/install/how-to-run-the-upgrade-advisor-analysis-wizard.md)  
