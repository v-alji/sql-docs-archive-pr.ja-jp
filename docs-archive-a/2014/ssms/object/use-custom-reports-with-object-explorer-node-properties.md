...
3.  で、 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] オブジェクトエクスプローラー内のノードを右クリックし、[**レポート**] をポイントして、[カスタムレポート] をクリックします。 **[ファイルを開く]** ダイアログ ボックスで、カスタム レポート フォルダーを見つけてレポート ファイルを選択し、 **[開く]** をクリックします。  
