...
# <a name="summary-configuring-permissions-on-database-objects"></a>概要 : データベース オブジェクトに対する権限の構成
 ...
 ビューとは、1 つの SELECT ステートメントであり、ユーザーにはテーブルのように表示されます。 ストアド プロシージャは、バッチとして実行される 1 つ以上の [!INCLUDE[tsql](../includes/tsql-md.md)] ステートメントです。  
  
## <a name="next-lesson-in-tutorial"></a>チュートリアルの次のレッスン  
