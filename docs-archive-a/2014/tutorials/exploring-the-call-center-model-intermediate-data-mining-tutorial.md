...
### <a name="using-the-variables-pane"></a>[変数] ペインの使用  
 このモデルでは、重要な要素として表示され `Average Time Per Issue` ます。 この変数は、問い合わせの種類に関係なく、問い合わせから回答までに要した平均時間を示します。  
...
1.  データマイニングデザイナーの [**マイニングモデルビューアー** ] タブで、を選択し \<mining model name> ます。  
