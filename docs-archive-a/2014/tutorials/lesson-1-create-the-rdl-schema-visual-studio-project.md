...
# <a name="lesson-1-create-the-rdl-schema-visual-studio-project"></a>レッスン 1 : RDL スキーマ Visual Studio プロジェクトの作成
  このチュートリアルでは、簡単なコンソール アプリケーションを作成します。 このチュートリアルは、で開発することを前提としてい [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vs_dev10_long](../includes/vs-dev10-long-md.md)] ます。  
...
4.  [**名前**] ボックスに、プロジェクトの名前を入力します。 名前を入力 `SampleRDLSchema` します。  
