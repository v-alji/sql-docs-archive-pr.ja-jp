...
4.  ファイルが保存されたら、コマンドプロンプトのインスタンスを開き [!INCLUDE[vs_dev10_long](../includes/vs-dev10-long-md.md)] ます。 コマンドプロンプトのインスタンスを開くには、[スタート] ボタンをクリックし、[**すべてのプログラム**]、[ **Microsoft Visual Studio 2010**]、[ **Visual Studio Tools**の順にポイントし、[ **Visual Studio コマンドプロンプト (2010)**] をクリックします。  
